...
namespace OctolizeShippingAustraliaPostVendor\Octolize\Onboarding\PluginUpgrade\MessageFactory;

use OctolizeShippingAustraliaPostVendor\Octolize\Onboarding\PluginUpgrade\PluginUpgradeMessage;
class LiveRatesFsRulesTable
{
    public function create_message(string $plugin_version, string $plugin_url)
    {
        return new PluginUpgradeMessage($plugin_version, trailingslashit($plugin_url) . 'vendor_prefixed/octolize/wp-onboarding/assets/images/icon-complex-solution.svg', __('We\'ve added integration with Flexible Shipping Table Rate', 'octolize-australia-post-shipping'), sprintf(
