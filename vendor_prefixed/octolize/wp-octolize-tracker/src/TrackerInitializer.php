...
namespace OctolizeShippingAustraliaPostVendor\Octolize\Tracker;

use OctolizeShippingAustraliaPostVendor\Octolize\Tracker\DeactivationTracker\OctolizeReasonsFactory;
use OctolizeShippingAustraliaPostVendor\Octolize\Tracker\OptInNotice\OptInNotice;
use OctolizeShippingAustraliaPostVendor\Octolize\Tracker\OptInNotice\ShouldDisplay;
use OctolizeShippingAustraliaPostVendor\Octolize\Tracker\OptInNotice\ShouldDisplayAlways;
use OctolizeShippingAustraliaPostVendor\Octolize\Tracker\OptInNotice\ShouldDisplayAndConditions;
use OctolizeShippingAustraliaPostVendor\Octolize\Tracker\OptInNotice\ShouldDisplayGetParameterPresent;
use OctolizeShippingAustraliaPostVendor\Octolize\Tracker\OptInNotice\ShouldDisplayGetParameterValue;
use OctolizeShippingAustraliaPostVendor\Octolize\Tracker\OptInNotice\ShouldDisplayOrConditions;
use OctolizeShippingAustraliaPostVendor\Octolize\Tracker\OptInNotice\ShouldDisplayShippingMethodInstanceSettings;
...
use OctolizeShippingAustraliaPostVendor\WPDesk\Tracker\Deactivation\PluginData;
use OctolizeShippingAustraliaPostVendor\WPDesk\Tracker\Deactivation\ReasonsFactory;
use OctolizeShippingAustraliaPostVendor\WPDesk\Tracker\Deactivation\TrackerFactory;
use OctolizeShippingAustraliaPostVendor\WPDesk\Tracker\PluginActionLinks;
/**
...
class TrackerInitializer implements HookableCollection
{
    ...
    public function hooks()
    {
        ...
        $tracker_consent = new \OctolizeShippingAustraliaPostVendor\WPDesk_Tracker_Persistence_Consent();
     ...
     */
    public static function create_from_plugin_info(\OctolizeShippingAustraliaPostVendor\WPDesk_Plugin_Info $plugin_info, $should_display, ReasonsFactory $reasons_factory = null)
    {
     ...
     * @return TrackerInitializer
     */
    public static function create_from_plugin_info_for_shipping_method(\OctolizeShippingAustraliaPostVendor\WPDesk_Plugin_Info $plugin_info, string $shipping_method_id, ReasonsFactory $reasons_factory = null)
    {
        $shops = $plugin_info->get_plugin_shops();
        $shop_url = $shops[get_locale()] ?? $shops['default'] ?? 'https://octolize.com';
