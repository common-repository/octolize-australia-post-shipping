...
namespace OctolizeShippingAustraliaPostVendor\Octolize\ShippingExtensions;

use OctolizeShippingAustraliaPostVendor\Octolize\ShippingExtensions\Plugin\Plugin;
use OctolizeShippingAustraliaPostVendor\Octolize\ShippingExtensions\Plugin\PluginFactory;
use OctolizeShippingAustraliaPostVendor\Octolize\ShippingExtensions\Plugin\PluginSorter;
use OctolizeShippingAustraliaPostVendor\Octolize\ShippingExtensions\Tracker\ViewPageTracker;
...
class Page implements Hookable
{
    ...
    {
        add_submenu_page(self::PARENT_SLUG, _x('Shipping Extensions', 'Page title', 'octolize-australia-post-shipping'), $this->get_menu_title(), 'manage_options', self::MENU_SLUG, [$this, 'render_page']);
    }
    /**
     * @return void
     */
    ...
    {
        $menu_title = nl2br(_x("Shipping\nExtensions", 'Menu Title', 'octolize-australia-post-shipping'));
