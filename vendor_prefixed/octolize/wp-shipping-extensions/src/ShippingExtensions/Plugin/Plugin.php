...
class Plugin implements JsonSerializable
{
    ...
    {
        return $this->category === PluginFactory::get_categories()[PluginFactory::CATEGORY_BUNDLES] ? __('Buy bundle →', 'octolize-australia-post-shipping') : __('Buy plugin →', 'octolize-australia-post-shipping');
    }
}
