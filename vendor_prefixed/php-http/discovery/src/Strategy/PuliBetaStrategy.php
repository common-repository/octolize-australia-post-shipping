...
use OctolizeShippingAustraliaPostVendor\Http\Discovery\Exception\PuliUnavailableException;
use OctolizeShippingAustraliaPostVendor\Puli\Discovery\Api\Discovery;
use OctolizeShippingAustraliaPostVendor\Puli\GeneratedPuliFactory;
/**
...
class PuliBetaStrategy implements DiscoveryStrategy
{
    ...
    private static function getPuliFactory()
    {
        if (null === self::$puliFactory) {
            if (!defined('OctolizeShippingAustraliaPostVendor\PULI_FACTORY_CLASS')) {
