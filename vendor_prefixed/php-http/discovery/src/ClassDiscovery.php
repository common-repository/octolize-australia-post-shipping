...
namespace OctolizeShippingAustraliaPostVendor\Http\Discovery;

use OctolizeShippingAustraliaPostVendor\Http\Discovery\Exception\ClassInstantiationFailedException;
use OctolizeShippingAustraliaPostVendor\Http\Discovery\Exception\DiscoveryFailedException;
use OctolizeShippingAustraliaPostVendor\Http\Discovery\Exception\NoCandidateFoundException;
use OctolizeShippingAustraliaPostVendor\Http\Discovery\Exception\StrategyUnavailableException;
use OctolizeShippingAustraliaPostVendor\Http\Discovery\Strategy\DiscoveryStrategy;
/**
