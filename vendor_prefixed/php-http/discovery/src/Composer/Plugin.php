...
namespace OctolizeShippingAustraliaPostVendor\Http\Discovery\Composer;

use OctolizeShippingAustraliaPostVendor\Composer\Composer;
use OctolizeShippingAustraliaPostVendor\Composer\DependencyResolver\Pool;
use OctolizeShippingAustraliaPostVendor\Composer\EventDispatcher\EventSubscriberInterface;
use OctolizeShippingAustraliaPostVendor\Composer\Factory;
use OctolizeShippingAustraliaPostVendor\Composer\Installer;
use OctolizeShippingAustraliaPostVendor\Composer\IO\IOInterface;
use OctolizeShippingAustraliaPostVendor\Composer\Json\JsonFile;
use OctolizeShippingAustraliaPostVendor\Composer\Json\JsonManipulator;
use OctolizeShippingAustraliaPostVendor\Composer\Package\Locker;
use OctolizeShippingAustraliaPostVendor\Composer\Package\Version\VersionParser;
use OctolizeShippingAustraliaPostVendor\Composer\Package\Version\VersionSelector;
use OctolizeShippingAustraliaPostVendor\Composer\Plugin\PluginInterface;
use OctolizeShippingAustraliaPostVendor\Composer\Repository\InstalledRepositoryInterface;
use OctolizeShippingAustraliaPostVendor\Composer\Repository\RepositorySet;
use OctolizeShippingAustraliaPostVendor\Composer\Script\Event;
use OctolizeShippingAustraliaPostVendor\Composer\Script\ScriptEvents;
use OctolizeShippingAustraliaPostVendor\Composer\Util\Filesystem;
...
class Plugin implements PluginInterface, EventSubscriberInterface
{
    ...
    private const INTERFACE_MAP = ['php-http/async-client-implementation' => ['OctolizeShippingAustraliaPostVendor\Http\Client\HttpAsyncClient'], 'php-http/client-implementation' => ['OctolizeShippingAustraliaPostVendor\Http\Client\HttpClient'], 'psr/http-client-implementation' => ['OctolizeShippingAustraliaPostVendor\Psr\Http\Client\ClientInterface'], 'psr/http-factory-implementation' => ['OctolizeShippingAustraliaPostVendor\Psr\Http\Message\RequestFactoryInterface', 'OctolizeShippingAustraliaPostVendor\Psr\Http\Message\ResponseFactoryInterface', 'OctolizeShippingAustraliaPostVendor\Psr\Http\Message\ServerRequestFactoryInterface', 'OctolizeShippingAustraliaPostVendor\Psr\Http\Message\StreamFactoryInterface', 'OctolizeShippingAustraliaPostVendor\Psr\Http\Message\UploadedFileFactoryInterface', 'OctolizeShippingAustraliaPostVendor\Psr\Http\Message\UriFactoryInterface']];
    ...
    public function getMissingRequires(InstalledRepositoryInterface $repo, array $requires, bool $isProject, array $pinnedAbstractions): array
    {
        ...
        if (ClassDiscovery::safeClassExists(\OctolizeShippingAustraliaPostVendor\Phalcon\Http\Message\RequestFactory::class, \false)) {
