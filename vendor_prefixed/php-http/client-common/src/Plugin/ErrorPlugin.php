...
use OctolizeShippingAustraliaPostVendor\Http\Client\Common\Exception\ClientErrorException;
use OctolizeShippingAustraliaPostVendor\Http\Client\Common\Exception\ServerErrorException;
