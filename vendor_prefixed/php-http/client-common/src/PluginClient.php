...
use OctolizeShippingAustraliaPostVendor\Http\Client\Promise\HttpFulfilledPromise;
use OctolizeShippingAustraliaPostVendor\Http\Client\Promise\HttpRejectedPromise;
