...
class CalculationParams
{
     ...
     */
    public function __construct(string $countryCode, string $serviceCode, ?float $weight = null, ?string $optionCode = null, ?string $subOptionCode = null, ?float $extraCover = null)
    {
