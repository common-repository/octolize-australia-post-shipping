...
namespace OctolizeShippingAustraliaPostVendor\Fontis\Auspost\Api\Postage\International\Parcel\Services;
...
class ServiceRequest
{
    ...
    {
        $urlParams = ['country_code' => $params->getCountryCode(), 'weight' => $params->getWeight()];
        return $urlParams;
    }
}
