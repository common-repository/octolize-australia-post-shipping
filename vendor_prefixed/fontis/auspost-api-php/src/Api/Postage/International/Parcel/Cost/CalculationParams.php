...
namespace OctolizeShippingAustraliaPostVendor\Fontis\Auspost\Api\Postage\International\Parcel\Cost;
...
class CalculationParams
{
     ...
     */
    public function __construct(string $countryCode, float $weight, string $serviceCode, ?string $optionCode = null, ?string $subOptionCode = null, ?float $extraCover = null)
    {
