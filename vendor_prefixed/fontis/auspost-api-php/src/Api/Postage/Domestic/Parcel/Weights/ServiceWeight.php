...
namespace OctolizeShippingAustraliaPostVendor\Fontis\Auspost\Api\Postage\Domestic\Parcel\Weights;
...
class ServiceWeight
{
    ...
    {
        $response = $this->httpClient->get('postage/parcel/domestic/weight.json');
