...
class ServiceCost
{
    ...
    {
        $urlParams = ['from_postcode' => $params->getFromPostcode(), 'to_postcode' => $params->getToPostcode(), 'length' => $params->getLength(), 'width' => $params->getWidth(), 'height' => $params->getHeight(), 'weight' => $params->getWeight(), 'service_code' => $params->getServiceCode()];
