...
namespace OctolizeShippingAustraliaPostVendor\Psr\Log\Test;
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('OctolizeShippingAustraliaPostVendor\Psr\Log\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('OctolizeShippingAustraliaPostVendor\Psr\Log\Test\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('OctolizeShippingAustraliaPostVendor\Psr\Log\Test\DummyTest', array('__toString'));
        }
