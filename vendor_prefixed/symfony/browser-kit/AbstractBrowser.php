 ...
 */
namespace OctolizeShippingAustraliaPostVendor\Symfony\Component\BrowserKit;

use OctolizeShippingAustraliaPostVendor\Symfony\Component\BrowserKit\Exception\BadMethodCallException;
use OctolizeShippingAustraliaPostVendor\Symfony\Component\DomCrawler\Crawler;
use OctolizeShippingAustraliaPostVendor\Symfony\Component\DomCrawler\Form;
use OctolizeShippingAustraliaPostVendor\Symfony\Component\DomCrawler\Link;
use OctolizeShippingAustraliaPostVendor\Symfony\Component\Process\PhpProcess;
/**
 * Simulates a browser.
 *
...
abstract class AbstractBrowser
{
    ...
    protected $redirect;
    protected $followRedirects = \true;
    protected $followMetaRefresh = \false;
    private $maxRedirects = -1;
    private $redirectCount = 0;
    private $redirects = [];
    private $isMainRequest = \true;
    /**
     ...
     */
    public function followRedirects(bool $followRedirects = \true)
    {
     ...
     */
    public function followMetaRefresh(bool $followMetaRefresh = \true)
    {
     ...
     */
    public function insulate(bool $insulated = \true)
    {
        if ($insulated && !class_exists(\OctolizeShippingAustraliaPostVendor\Symfony\Component\Process\Process::class)) {
    ...
    public function xmlHttpRequest(string $method, string $uri, array $parameters = [], array $files = [], array $server = [], ?string $content = null, bool $changeHistory = \true): Crawler
    {
     ...
     */
    public function jsonRequest(string $method, string $uri, array $parameters = [], array $server = [], bool $changeHistory = \true): Crawler
    {
     ...
     * @return Crawler
     */
    public function request(string $method, string $uri, array $parameters = [], array $files = [], array $server = [], ?string $content = null, bool $changeHistory = \true)
    {
        ...
        if ($this->followRedirects && $this->redirect) {
            $this->redirects[serialize($this->history->current())] = \true;
     ...
     * @return Crawler
     */
    protected function requestFromRequest(Request $request, bool $changeHistory = \true)
    {
