 ...
 */
namespace OctolizeShippingAustraliaPostVendor\Symfony\Component\String;

use OctolizeShippingAustraliaPostVendor\Symfony\Component\String\Exception\ExceptionInterface;
use OctolizeShippingAustraliaPostVendor\Symfony\Component\String\Exception\InvalidArgumentException;
use OctolizeShippingAustraliaPostVendor\Symfony\Component\String\Exception\RuntimeException;
/**
...
abstract class AbstractUnicodeString extends AbstractString
{
    ...
    {
        $str = clone $this;
        if (!$compat || \PHP_VERSION_ID < 70300 || !\defined('OctolizeShippingAustraliaPostVendor\Normalizer::NFKC_CF')) {
