...
use OctolizeShippingAustraliaPostVendor\GuzzleHttp\Psr7\Response;
...
final class EasyHandle
{
    ...
    public function createResponse()
    {
        ...
        $headers = \OctolizeShippingAustraliaPostVendor\GuzzleHttp\headers_from_lines($this->headers);
