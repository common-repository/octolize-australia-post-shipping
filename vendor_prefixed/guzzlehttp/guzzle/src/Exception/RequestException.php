...
namespace OctolizeShippingAustraliaPostVendor\GuzzleHttp\Exception;
...
class RequestException extends TransferException
{
    ...
    {
        return \OctolizeShippingAustraliaPostVendor\GuzzleHttp\Psr7\get_message_body_summary($response);
    }
    /**
