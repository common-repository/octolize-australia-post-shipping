...
use OctolizeShippingAustraliaPostVendor\GuzzleHttp\Exception\BadResponseException;
use OctolizeShippingAustraliaPostVendor\GuzzleHttp\Exception\TooManyRedirectsException;
