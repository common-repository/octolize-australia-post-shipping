...
use OctolizeShippingAustraliaPostVendor\Swift_Message;
use OctolizeShippingAustraliaPostVendor\Swift;
/**
...
class SwiftMailerHandler extends MailHandler
{
     ...
     */
    public function __construct(\OctolizeShippingAustraliaPostVendor\Swift_Mailer $mailer, $message, $level = Logger::ERROR, bool $bubble = \true)
    {
