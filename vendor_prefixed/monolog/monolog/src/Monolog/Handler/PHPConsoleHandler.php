...
use OctolizeShippingAustraliaPostVendor\Monolog\Formatter\LineFormatter;
...
use OctolizeShippingAustraliaPostVendor\Monolog\Utils;
use OctolizeShippingAustraliaPostVendor\PhpConsole\Connector;
use OctolizeShippingAustraliaPostVendor\PhpConsole\Handler as VendorPhpConsoleHandler;
use OctolizeShippingAustraliaPostVendor\PhpConsole\Helper;
/**
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    {
        if (!class_exists('OctolizeShippingAustraliaPostVendor\PhpConsole\Connector')) {
