...
use OctolizeShippingAustraliaPostVendor\Elastic\Elasticsearch\Response\Elasticsearch;
use Throwable;
...
use OctolizeShippingAustraliaPostVendor\Monolog\Formatter\ElasticsearchFormatter;
use InvalidArgumentException;
use OctolizeShippingAustraliaPostVendor\Elasticsearch\Common\Exceptions\RuntimeException as ElasticsearchRuntimeException;
use OctolizeShippingAustraliaPostVendor\Elasticsearch\Client;
use OctolizeShippingAustraliaPostVendor\Elastic\Elasticsearch\Exception\InvalidArgumentException as ElasticInvalidArgumentException;
use OctolizeShippingAustraliaPostVendor\Elastic\Elasticsearch\Client as Client8;
/**
