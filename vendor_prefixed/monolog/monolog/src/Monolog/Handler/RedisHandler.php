...
class RedisHandler extends AbstractProcessingHandler
{
    ...
    {
        if (!($redis instanceof \OctolizeShippingAustraliaPostVendor\Predis\Client || $redis instanceof \Redis)) {
    ...
    protected function writeCapped(array $record): void
    {
        if ($this->redisClient instanceof \Redis) {
            $mode = defined('OctolizeShippingAustraliaPostVendor\Redis::MULTI') ? \Redis::MULTI : 1;
