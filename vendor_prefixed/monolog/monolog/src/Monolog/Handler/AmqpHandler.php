...
use OctolizeShippingAustraliaPostVendor\Monolog\Formatter\JsonFormatter;
use OctolizeShippingAustraliaPostVendor\PhpAmqpLib\Message\AMQPMessage;
use OctolizeShippingAustraliaPostVendor\PhpAmqpLib\Channel\AMQPChannel;
use AMQPExchange;
/**
