...
?>" style="display:none;">
	<h2><?php 
echo \sprintf(\__('You are deactivating %s plugin.', 'octolize-australia-post-shipping'), $plugin_title);
?></h2>
...
?>">
		<div class="body">
			<div class="panel active" data-panel-id="reasons">
				<p><?php 
\_e('Before you proceed, please take 30 seconds to let us know what brought you to this decision. Your answers are anonymous.', 'octolize-australia-post-shipping');
?></p>
...
\_e('Skip &amp; Deactivate', 'octolize-australia-post-shipping');
?></a>
                </div>
...
?>><?php 
\_e('Submit &amp; Deactivate', 'octolize-australia-post-shipping');
?></button>
                    <button href="#" class="button button-secondary button-close tracker-button-close"><?php 
\_e('Cancel', 'octolize-australia-post-shipping');
?></button>
                </div>
