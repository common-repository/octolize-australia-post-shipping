...
if (!\class_exists('OctolizeShippingAustraliaPostVendor\WPDesk_Logger')) {
    /**
    ...
    class WPDesk_Logger
    {
        ...
        {
            if (!self::$logger) {
                $loggerFactroy = new \OctolizeShippingAustraliaPostVendor\WPDesk\Logger\WPDeskLoggerFactory();
        ...
        {
            return ['disabled' => \__('Disabled', 'octolize-australia-post-shipping'), 'emergency' => \__('Emergency', 'octolize-australia-post-shipping'), 'alert' => \__('Alert', 'octolize-australia-post-shipping'), 'critical' => \__('Critical', 'octolize-australia-post-shipping'), 'error' => \__('Error', 'octolize-australia-post-shipping'), 'warning' => \__('Warning', 'octolize-australia-post-shipping'), 'notice' => \__('Notice', 'octolize-australia-post-shipping'), 'info' => \__('Info', 'octolize-australia-post-shipping'), 'debug' => \__('Debug', 'octolize-australia-post-shipping')];
        }
        /**
         * @param string $level
         * @param string $source
