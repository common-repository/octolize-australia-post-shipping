...
use LogicException;
use OctolizeShippingAustraliaPostVendor\Monolog\Handler\NullHandler;
use OctolizeShippingAustraliaPostVendor\Monolog\Logger;
use OctolizeShippingAustraliaPostVendor\Monolog\Registry;
use OctolizeShippingAustraliaPostVendor\Monolog\Handler\StreamHandler;
use OctolizeShippingAustraliaPostVendor\Psr\Log\LogLevel;
use OctolizeShippingAustraliaPostVendor\WPDesk\Logger\WC\WooCommerceCapture;
use OctolizeShippingAustraliaPostVendor\WPDesk\Logger\WP\WPCapture;
/**
...
class WPDeskLoggerFactory extends BasicLoggerFactory
{
    ...
    {
        if (!defined('OctolizeShippingAustraliaPostVendor\WC_LOG_THRESHOLD')) {
            define('OctolizeShippingAustraliaPostVendor\WC_LOG_THRESHOLD', self::LEVEL_WC);
        }
