...
namespace OctolizeShippingAustraliaPostVendor\WPDesk\Logger\WP;
...
class WPCapture
{
    ...
    {
        new \OctolizeShippingAustraliaPostVendor\WPDesk\Notice\Notice(sprintf(
            // Translators: directory.
            __('Can not enable WP Desk Debug log! Cannot create directory %s or this directory is not writeable!', 'octolize-australia-post-shipping'),
            $dir
        ), \OctolizeShippingAustraliaPostVendor\WPDesk\Notice\Notice::NOTICE_TYPE_ERROR);
    }
    /**
     * Add notice for file.
     *
    ...
    private function add_notice_for_file($file)
    {
        new \OctolizeShippingAustraliaPostVendor\WPDesk\Notice\Notice(sprintf(
            // Translators: directory.
            __('Can not enable WP Desk Debug log! Cannot create file %s!', 'octolize-australia-post-shipping'),
            $file
        ), \OctolizeShippingAustraliaPostVendor\WPDesk\Notice\Notice::NOTICE_TYPE_ERROR);
    }
    /**
