 ...
 */
namespace OctolizeShippingAustraliaPostVendor\WPDesk\AbstractShipping\UnitConversion;
...
class UniversalDimension
{
    ...
    public function as_unit_rounded($to_unit, $precision = 2)
    {
        ...
        throw new UnitConversionException(__('Can\'t convert weight to target unit.', 'octolize-australia-post-shipping'));
    }
}
