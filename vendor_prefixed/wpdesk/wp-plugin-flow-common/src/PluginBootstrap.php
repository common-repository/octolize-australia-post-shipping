...
namespace OctolizeShippingAustraliaPostVendor\WPDesk\Plugin\Flow;

use OctolizeShippingAustraliaPostVendor\WPDesk\Plugin\Flow\Initialization\InitializationFactory;
/**
...
{
    const LIBRARY_TEXT_DOMAIN = 'octolize-australia-post-shipping';
     ...
     */
    private function init_translations(\OctolizeShippingAustraliaPostVendor\WPDesk_Plugin_Info $plugin_info)
    {
        $lang_dir = 'lang';
    ...
    private function create_requirements_checker()
    {
        ...
        $requirements_checker_factory = new \OctolizeShippingAustraliaPostVendor\WPDesk_Basic_Requirement_Checker_Factory();
    ...
    {
        $plugin_info = new \OctolizeShippingAustraliaPostVendor\WPDesk_Plugin_Info();
