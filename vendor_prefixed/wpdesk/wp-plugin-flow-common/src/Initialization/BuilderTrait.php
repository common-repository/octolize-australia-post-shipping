...
namespace OctolizeShippingAustraliaPostVendor\WPDesk\Plugin\Flow\Initialization;

use OctolizeShippingAustraliaPostVendor\WPDesk\PluginBuilder\Plugin\Activateable;
use OctolizeShippingAustraliaPostVendor\WPDesk\PluginBuilder\Plugin\Deactivateable;
...
trait BuilderTrait
{
     ...
     * @return SlimPlugin
     */
    private function build_plugin(\OctolizeShippingAustraliaPostVendor\WPDesk_Plugin_Info $plugin_info)
    {
     ...
     * @return SlimPlugin
     */
    private function init_register_hooks(\OctolizeShippingAustraliaPostVendor\WPDesk_Plugin_Info $plugin_info, SlimPlugin $plugin)
    {
