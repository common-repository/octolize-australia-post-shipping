...
namespace OctolizeShippingAustraliaPostVendor\WPDesk\Plugin\Flow\Initialization\Simple;

use OctolizeShippingAustraliaPostVendor\WPDesk\Helper\HelperRemover;
use OctolizeShippingAustraliaPostVendor\WPDesk\Helper\PrefixedHelperAsLibrary;
use OctolizeShippingAustraliaPostVendor\WPDesk\License\PluginRegistrator;
use OctolizeShippingAustraliaPostVendor\WPDesk\Plugin\Flow\Initialization\ActivationTrait;
use OctolizeShippingAustraliaPostVendor\WPDesk\Plugin\Flow\Initialization\BuilderTrait;
use OctolizeShippingAustraliaPostVendor\WPDesk\Plugin\Flow\Initialization\PluginDisablerByFileTrait;
use OctolizeShippingAustraliaPostVendor\WPDesk\Plugin\Flow\Initialization\InitializationStrategy;
use OctolizeShippingAustraliaPostVendor\WPDesk\PluginBuilder\Plugin\ActivationAware;
use OctolizeShippingAustraliaPostVendor\WPDesk\PluginBuilder\Plugin\SlimPlugin;
/**
...
class SimplePaidStrategy implements InitializationStrategy
{
    ...
    /** @var SlimPlugin */
    private $plugin;
    public function __construct(\OctolizeShippingAustraliaPostVendor\WPDesk_Plugin_Info $plugin_info)
    {
     ...
     * @return SlimPlugin
     */
    public function run_before_init(\OctolizeShippingAustraliaPostVendor\WPDesk_Plugin_Info $plugin_info)
    {
     ...
     * @return SlimPlugin
     */
    public function run_init(\OctolizeShippingAustraliaPostVendor\WPDesk_Plugin_Info $plugin_info)
    {
        if (!$this->plugin) {
            $this->plugin = $this->build_plugin($plugin_info);
        }
