 ...
 */
namespace OctolizeShippingAustraliaPostVendor\WPDesk\WooCommerceShipping\Ups\MetaDataInterpreters;

use OctolizeShippingAustraliaPostVendor\WPDesk\WooCommerceShipping\OrderMetaData\AdminMetaDataUnchangedTrait;
use OctolizeShippingAustraliaPostVendor\WPDesk\WooCommerceShipping\OrderMetaData\PackedPackagesMetaDataBuilder;
use OctolizeShippingAustraliaPostVendor\WPDesk\WooCommerceShipping\OrderMetaData\SingleAdminOrderMetaDataInterpreter;
...
class PackedPackagesAdminMetaDataInterpreter implements SingleAdminOrderMetaDataInterpreter
{
    ...
    {
        return __('Packages', 'octolize-australia-post-shipping');
    }
    /**
