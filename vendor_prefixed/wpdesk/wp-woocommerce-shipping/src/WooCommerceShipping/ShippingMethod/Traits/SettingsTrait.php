...
use OctolizeShippingAustraliaPostVendor\WPDesk\WooCommerceShipping\ApiStatus\ApiStatusSettingsDefinitionDecorator;
use OctolizeShippingAustraliaPostVendor\WPDesk\WooCommerceShipping\CustomFields\CouldNotFindService;
use OctolizeShippingAustraliaPostVendor\WPDesk\WooCommerceShipping\CustomFields\Services\FieldServices;
use OctolizeShippingAustraliaPostVendor\WPDesk\WooCommerceShipping\CustomFields\FieldHandlingFees;
use OctolizeShippingAustraliaPostVendor\WPDesk\WooCommerceShipping\CustomFields\FieldsFactory;
use OctolizeShippingAustraliaPostVendor\WPDesk\WooCommerceShipping\CustomOrigin\CustomOriginFields;
use OctolizeShippingAustraliaPostVendor\WPDesk\WooCommerceShipping\CustomOrigin\InstanceCustomOriginFields;
use OctolizeShippingAustraliaPostVendor\WPDesk\WooCommerceShipping\FreeShipping\FreeShippingFields;
use OctolizeShippingAustraliaPostVendor\WPDesk\WooCommerceShipping\HandlingFees\PriceAdjustmentNone;
use OctolizeShippingAustraliaPostVendor\WPDesk\WooCommerceShipping\PluginShippingDecisions;
use OctolizeShippingAustraliaPostVendor\WPDesk\WooCommerceShipping\ShippingMethod\HasCustomOrigin;
use OctolizeShippingAustraliaPostVendor\WPDesk\WooCommerceShipping\ShippingMethod\HasInstanceCustomOrigin;
use OctolizeShippingAustraliaPostVendor\WPDesk\WooCommerceShipping\ShippingMethod\HasFreeShipping;
use OctolizeShippingAustraliaPostVendor\WPDesk\WooCommerceShipping\ShippingMethod\HasHandlingFees;
use OctolizeShippingAustraliaPostVendor\WPDesk\WooCommerceShipping\ShippingMethod\MethodFieldsFactory;
use OctolizeShippingAustraliaPostVendor\WPDesk\WooCommerceShipping\ShippingMethod\RateMethod\Fallback\FallbackRateMethod;
use OctolizeShippingAustraliaPostVendor\WPDesk\WooCommerceShipping\ShippingMethod\RulesTableAdv;
/**
    ...
    private function replace_fallback_field_if_exists($settings)
    {
        ...
        foreach ($settings as $key => $field) {
            if ($field['type'] === FallbackRateMethod::FIELD_TYPE_FALLBACK) {
                $new_settings[FallbackRateMethod::FIELD_ENABLE_FALLBACK] = ['title' => __('Fallback', 'octolize-australia-post-shipping'), 'type' => 'checkbox', 'label' => __('Enable fallback', 'octolize-australia-post-shipping'), 'description' => __('Enable to offer flat rate cost for shipping so that the user can still checkout, if API for some reason returns no matching rates.', 'octolize-australia-post-shipping'), 'desc_tip' => \true, 'default' => 'no'];
                $new_settings[FallbackRateMethod::FIELD_FALLBACK_COST] = ['title' => __('Fallback Cost', 'octolize-australia-post-shipping'), 'type' => 'price', 'required' => \true, 'description' => __('Enter only a numeric value without the currency symbol.', 'octolize-australia-post-shipping'), 'desc_tip' => \true, 'default' => ''];
            } else {
