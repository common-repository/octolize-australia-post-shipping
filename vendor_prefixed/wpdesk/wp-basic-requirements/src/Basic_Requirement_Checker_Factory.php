...
if (!\class_exists('OctolizeShippingAustraliaPostVendor\Basic_Requirement_Checker')) {
    require_once __DIR__ . '/Basic_Requirement_Checker.php';
}
if (!\class_exists('OctolizeShippingAustraliaPostVendor\WPDesk_Basic_Requirement_Checker_With_Update_Disable')) {
