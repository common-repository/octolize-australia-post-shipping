...
?>">
			<?php 
\esc_html_e('Set image', 'octolize-australia-post-shipping');
?>
		</a>
...
?>" href="#">
			<?php 
\esc_html_e('Remove image', 'octolize-australia-post-shipping');
?>
		</a>
	</p>
</div>
...
?>' ),
		...
		addImgLink.on( 'click', function ( event ) {
			...
			frame = wp.media( {
				title: "<?php 
\esc_html_e('Select or Upload Media', 'octolize-australia-post-shipping');
?>",
				button: {
					text: "<?php 
\esc_html_e('Use this media', 'octolize-australia-post-shipping');
?>"
				},
				library: {
					type: ['image']
