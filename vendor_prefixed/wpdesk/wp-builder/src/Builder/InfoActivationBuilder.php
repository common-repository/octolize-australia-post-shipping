...
namespace OctolizeShippingAustraliaPostVendor\WPDesk\PluginBuilder\Builder;
...
use OctolizeShippingAustraliaPostVendor\WPDesk\PluginBuilder\Storage\PluginStorage;
/**
...
class InfoActivationBuilder extends AbstractBuilder
{
     ...
     */
    public function __construct(\OctolizeShippingAustraliaPostVendor\WPDesk_Buildable $info, $is_active)
    {
        $this->info = $info;
